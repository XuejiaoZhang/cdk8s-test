 ...
 */
export declare class RunGlueJobTask implements sfn.IStepFunctionsTask {
    private readonly glueJobName;
    private readonly props;
    private readonly integrationPattern;
    constructor(glueJobName: string, props?: RunGlueJobTaskProps);
