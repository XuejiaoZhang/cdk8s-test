...
export declare abstract class Secret {
     ...
     * Manager.
     */
    static fromSecretsManager(secret: secretsmanager.ISecret): Secret;
...
export declare class ContainerDefinition extends cdk.Construct {
     ...
     */
    constructor(scope: cdk.Construct, id: string, props: ContainerDefinitionProps);
    /**
     ...
     */
    renderContainerDefinition(taskDefinition?: TaskDefinition): CfnTaskDefinition.ContainerDefinitionProperty;
}
/**
 * The health check command and associated configuration parameters for the container.
 */
