...
/** @experimental */
export declare function bootstrapEnvironment(environment: cxapi.Environment, aws: ISDK, toolkitStackName: string, roleArn: string | undefined, props?: BootstrapEnvironmentProps): Promise<DeployStackResult>;
